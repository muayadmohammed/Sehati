...
class MyApp1 extends StatefulWidget {
  ...
  const MyApp1({Key navKey}) : super(key: navKey);
  @override
...
class _MyApp1State extends State<MyApp1> {
  ...
  addItemDialog() async {
    return await showDialog(
      context: MyApp1.navKey.currentState.overlay.context,
              ...
              addItemDialog().then((value) async {
                if (value != null &&
                    editableItems.indexWhere(
                        ...
                        -1) {
                  Navigator.pop(
                      MyApp1.navKey.currentState.overlay.context);
                  updateParent(value);
                }
              });
            },
      ...
      "Single dialog dark mode": Card(
        ...
        child: SearchChoices.single(
          ...
          closeButton: FlatButton(
            onPressed: () {
              Navigator.pop(MyApp1.navKey.currentState.overlay.context);
            },
            child: Text(
              "Close",
              style: TextStyle(color: Colors.white),
